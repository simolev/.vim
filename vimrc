...
" add n new lines below or above the current line
nnoremap <silent> <Space><Up>   :<C-u>put!=repeat(nr2char(10),v:count)<Bar>execute "'[+1"<CR>
nnoremap <silent> <Space><Down> :<C-u>put =repeat(nr2char(10),v:count)<Bar>execute "'[-1"<CR>
" "  }}}
" eof
